...
class ROI_NN(nn.Module):
    def __init__(self, in_features):
        super().__init__()
        self.shared_input_layer = nn.Linear(in_features, 512)
        self.bn_shared = nn.BatchNorm1d(512)

        self.reg_layer1 = nn.Linear(512, 256)
        ...
        self.prob_layer1 = nn.Linear(512, 256)
        self.bn_prob1 = nn.BatchNorm1d(256)
        self.prob_layer2 = nn.Linear(256, 256)
        self.bn_prob2 = nn.BatchNorm1d(256)
